...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a recharge intent' }),
...
__decorate([
    (0, common_1.Post)('verify-mock'),
    (0, swagger_1.ApiOperation)({ summary: 'Mock verify payment (DEV ONLY)' }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "verifyMock", null);
